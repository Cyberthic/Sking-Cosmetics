    ...
    return (
        <div className="min-h-screen w-full flex bg-white text-black overflow-hidden relative">
            ...
            <div className="w-full flex items-center justify-center p-8 md:p-16 relative z-10">
                ...
                >
                    <Link href="/register" className="inline-flex items-center text-sm font-bold text-gray-400 hover:text-sking-pink mb-8 transition-colors uppercase tracking-widest gap-2">
                    ...
                    <div className="text-center mb-10">
                        <div className="w-20 h-20 bg-sking-pink/10 rounded-full flex items-center justify-center mx-auto mb-6">
                            <KeyRound className="w-10 h-10 text-sking-pink" />
                        </div>
                        <h1 className="text-3xl font-bold text-gray-900 mb-2 uppercase tracking-tight">Verify Your Email</h1>
