...
export default function WalletPage() {
    return (
        <div>
            <h1 className="text-3xl font-black mb-8 uppercase tracking-tighter hidden md:block text-black">
                My Wallet <span className="text-sking-red text-sm font-bold tracking-widest ml-2 bg-red-50 px-3 py-1 rounded-full">Coming Soon</span>
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex gap-3">
                            <button className="bg-white/10 text-white/50 cursor-not-allowed border border-white/20 px-6 py-3 rounded-lg text-xs font-bold uppercase tracking-wide flex items-center gap-2">
                ...
                >
                    ...
                    <div className="flex flex-col items-center justify-center h-44 text-center">
                        ...
                        <p className="text-gray-500 text-xs mb-3 font-bold uppercase tracking-widest">Feature coming soon</p>
                        <button className="text-gray-400 cursor-not-allowed text-xs font-bold uppercase tracking-widest transition-colors border border-gray-200 px-6 py-3 rounded-full">
