...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-black py-10">
            {/* Background Gradients */}
            <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-purple-900/40 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-blue-900/40 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="w-full max-w-md mx-4 p-8 rounded-3xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-400">Join the Sking Cosmetics community today.</p>
                </div>
