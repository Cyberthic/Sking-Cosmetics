...
export interface IUserProductRepository extends IBaseRepository<IProduct> {
    ...
    reserveStock(productId: string, variantName: string | undefined, quantity: number): Promise<void>;
    commitStock(productId: string, variantName: string | undefined, quantity: number): Promise<void>;
    releaseStock(productId: string, variantName: string | undefined, quantity: number): Promise<void>;
}
